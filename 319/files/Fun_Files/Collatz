...
local function dichotomy(a='Yes',b='No') --Gives a selection of two choices, a or b, returning true for a and false for b
	sel=true
	while true do
		if sel then
			write("--> "..a.."     "..b)
...
write()
local num=numbersOnly('Give number for collatz: ',12)
local initial=num
local count=0
local maxV=1
print(num)
